...
def _missing_required_streamlit_text(app_path: Path, scenario: str) -> list[str]:
    ...
    required = [
        ...
        "Only the selected surface renders",
        "--density-row-height",
        "CHART_HEIGHT_SCALE",
        "compact_chart_label",
        "compact_chart_legend",
        "FONT_THEME_OPTIONS",
        "Font theme",
        ...
        "All point forecasts - no prediction intervals",
        "All interval-capable models - with prediction intervals",
        "Inverse-error weighted ensemble",
        "Rolling-origin CV window player",
        "Use Previous/Next or drag the cutoff slider",
        "Ledger table browser",
